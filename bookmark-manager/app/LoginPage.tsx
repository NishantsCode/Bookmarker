          ...
          <div className="mb-8 space-y-4">
            <div className="flex items-start gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Save and manage all your favorite websites in one place</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Your bookmarks are protected with Google authentication</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Access your bookmarks from any device, anytime</p>
              </div>
            </div>
          </div>
